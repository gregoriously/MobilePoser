"""SMPL <-> RBDL pose conversion helpers, ported verbatim from PIP (Xinyu-Yi/PIP,
utils.py). Required by the physics optimizer in dynamics.py. The index tables
encode the joint ordering / coordinate convention of the ported physics.urdf, so
do not edit them unless the RBDL model changes.
"""
...
__all__ = ['set_pose', 'smpl_to_rbdl', 'rbdl_to_smpl', 'smpl_to_rbdl_data', 'Body']
...
class Body(enum.Enum):
    r"""Prefix L = left; Prefix R = right."""
    ROOT = 2
    PELVIS = 2
    SPINE = 2
    LHIP = 5
